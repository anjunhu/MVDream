...
if __name__ == "__main__":
    ...
    # load contents from laion-10k
    with open('/home/ubuntu/code/laion_combined_captions.json', 'r') as file:
        data = json.load(file)

    os.makedirs(f"laion_10k_{args.laion_data_ordinal:06d}", exist_ok=True)
    
    for t in data[f"data/laion_10k_random/train/images_large/{args.laion_data_ordinal:06d}.png"]:
        images = []
        print(t)
        for j in range(3):
        ...
        t = re.sub(r'\W+', '_', t)
        Image.fromarray(images).save(f"laion_10k_{args.laion_data_ordinal:06d}/{t}.png")